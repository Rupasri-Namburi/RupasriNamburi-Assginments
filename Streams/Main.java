...
public class Main {
	public static void main(String[] args) {
        ...
        Trader_list.add(new Traders("jhon", "USA"));
        Trader_list.add(new Traders("Lacky", "UK"));
        Trader_list.add(new Traders("Aria", "Russia"));
        Trader_list.add(new Traders("Ayan", "India"));
        Trader_list.add(new Traders("Bellen", "Londen"));
        Trader_list.add(new Traders("Ahaar", "India"));
        ...
        //10. Trader who are in USA
       
        System.out.println("Trader in USA");
        Trader_list.stream().filter(x -> x.getCity().contains("USA")).forEach(System.out::println);
        ...
        //12. Are any traders based in UK
       
        boolean checkindore = Trader_list.stream().anyMatch(x -> x.getCity().contains("UK"));
        System.out.println("Are there any trader based in UK: " + checkindore);

        List<Transaction> Trans_list = Arrays.asList(
                new Transaction(new Traders("Ayan", "India"), 2012, 4500),
                new Transaction(new Traders("Bellen", "Londen"), 2011, 4800),
                new Transaction(new Traders("Ahaar", "India"), 2011, 4400));
        ...
        //13. Transaction from traders living in India
        
        System.out.println("Transaction from traders living in India");
        Trans_list.stream().filter(x -> x.getT().getCity().contains("India")).map(Transaction::getValue).forEach(System.out::println);
